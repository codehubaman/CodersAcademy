        ...
        <div >
          <header className="text-center text-4xl font-semibold mt-7">
            ...
            <p className="text-center text-richblack-600 mx-auto text-base font-medium w-[70%] mt-7 mb-20">
              CodersAcademy is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.
            </p>
          </header>
