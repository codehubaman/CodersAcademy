...
export function updateProfile(token, formData) {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("UPDATE_PROFILE_API Response:", response.data);
      ...
      const updatedUser = response.data.profile; // Make sure the backend returns "profile"
      ...
      // Update Redux state with latest user data from DB
